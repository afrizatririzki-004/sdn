...
#
# CONTROLLER MESH - OPTIMIZED FOR SMALL SCALE (10 NODES)
# Menggunakan logika yang sama dengan versi 50 Nodes yang sukses,
# tetapi dengan waktu tunggu jauh lebih pendek.
...
class JohnsonMeshUltraController(app_manager.RyuApp):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # PERUBAHAN: Lock Time dipendekan untuk 10 Node (1 Menit sudah overkill)
        self.initial_lock = 60.0 
        self.is_ready = False
        self.calc_in_progress = False
       
        self.logger.info("JohnsonMeshUltraController (10-NODE OPTIMIZED): Ready.")
    ...
    def _monitor_topology(self):
        while True:
            hub.sleep(10.0) # Monitor interval sama
