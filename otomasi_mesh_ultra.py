...
def run_mesh_test(nodes_or_k, algo_name="JOHNSON_COOLDOWN"):
    ...
    # UPDATE: Waktu tunggu ditingkatkan signifikan
    # Controller butuh 30 detik STABILITY setelah link terakhir ditemukan.
    # Untuk 20 node: discovery butuh ~20s, stabilisasi 30s = total 50s+.
    # Untuk 50 node: butuh lebih lama.
