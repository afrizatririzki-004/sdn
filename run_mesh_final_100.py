...
def measure_convergence(net, target_host_1, target_host_2, timeout=300):
    ...
    while True:
        ...
        if time.time() - start_time > timeout:
            return None
        time.sleep(1) # Tidur 1 detik agar tidak spam CPU saat menunggu ping
...
def run_mesh_test(nodes_or_k, algo_name="FINAL_NO_WARMUP"):
    ...
    # --- HAPUS WARM UP ---
    # Kita tidak melakukan pingAll. Kita langsung tes.
    # Ryu akan menghitung jalur saat paket pertama datang (PacketIn).
    # Beban CPU akan sedikit lebih lambat di awal, tapi tidak akan CRASH.
    # ----------------------------------------
